...
describe("separação funcional de conta e recebimento", () => {
  it("mantém Meus dados restrito a nome, e-mail e senha", () => {
    const result = accountInput.safeParse({ name: "Membro Página Lucrativa", email: "membro@example.com", newPassword: null, confirmPassword: null });
  ...
  it("aceita o payload completo de recebimento no contrato correto", () => {
    const result = receivingPreferenceInput.safeParse({
      holderName: "Membro Página Lucrativa",
      method: "pix",
      ...
      bank1Type: "checking",
      bank1Holder: "Membro Página Lucrativa",
      bank2Name: "Banco Dois",
      bank2Agency: "4321",
      bank2Account: "12345-6",
      bank2Type: "savings",
      bank2Holder: "Membro Página Lucrativa",
      pixType: "e-mail",
  ...
  it("rejects a mismatched new password confirmation", () => {
    const result = accountInput.safeParse({ name: "Membro Página Lucrativa", email: "membro@example.com", newPassword: "nova-senha", confirmPassword: "outra-senha" });
