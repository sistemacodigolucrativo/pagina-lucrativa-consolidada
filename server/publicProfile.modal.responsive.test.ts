...
describe("public profile summary and modal", () => {
  ...
  it("shows only essential summary information and exposes Ver mais dialog", () => {
    ...
    expect(homeSource).not.toContain("Apresentador(a) do Método Código Lucrativo");
    ...
    expect(homeSource).not.toContain("footer-whatsapp");
  ...
  it("provides scroll-safe responsive modal styles", () => {
    ...
    expect(cssSource).toContain("color: #D98A28; font: 760 clamp(13px, 4cqw, 16px)/1.16");
