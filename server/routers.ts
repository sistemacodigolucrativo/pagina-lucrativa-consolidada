...
export const appRouter = router({
  ...
  admin: router({
    ...
    deleteAllTestimonials: adminProcedure.input(z.object({ confirmation: z.literal("DELETAR AGRADECIMENTOS") })).mutation(({ ctx, input }) => deleteAllAdminTestimonials(ctx.user.id, input.confirmation)),
