...
//$pro_click1 = "SELECT price FROM tb_config WHERE item='Pro_click' and howmany='1'";
//$free_click1 = "SELECT price FROM tb_config WHERE item='Free_click' and howmany='1'";
...
//$pro_click2 = mysql_query($pro_click1);
//$free_click2 = mysql_query($free_click1);
...
//$pro_click3 = mysql_query($pro_click2);
//$free_click3 = mysql_query($free_click2);
...
$config['pro_click'] = "$pro_click";
$config['free_click'] = "$free_click";
$config['site_path'] = "$script_path";
$config['copyright'] = "<font color='#C0C0C0'><center>&copy; {$config['site_name']} 2008 | <a target='_blank' href='LeilsonLima'>Todos os Direitos Reservados</a> {$VERNO}</center></font>";

///////////////////////////////////////////////////////////////////////////////////////////////

////////////////////////////////////// EDIT BELOW ////////////////////////////////////////////

$config['footermenu'] = "<a href='index.php?option=privacy'>Privacidade</a> | <a href='index.php?option=tos'>Termos do Serviço</a> | <a target='_blank' href='{$config["forum"]}'>Forum</a> | <a href='index.php?option=banner'>Banners</a> | <a href='index.php?option=proof'>Prova de Pagamentos</a> | <a href='buyref.php?refs=35'>Comprar Referidos</a> | <a href='user.php?option=upgrade'>Upgrade Premium</a>";
if($loggedin == 1)
{
...
$config["menu"] = "	<li><a href=\"index.php?option=home\">Home</a></li>
					...
					<li><a href=\"index.php?option=surf\">Ver Anuncios</a></li>
					<li><a href=\"user.php?option=stats\">Status</a></li>
					<li><a href=\"index.php?option=how\">Como?</a></li>
					<li><a href=\"index.php?option=faq\">FAQs</a></li>
					<li><a href=\"index.php?option=advertise\">Anuncie</a></li>
