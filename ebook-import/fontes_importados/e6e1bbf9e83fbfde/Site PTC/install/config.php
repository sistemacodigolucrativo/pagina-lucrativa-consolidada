...
$dusername 		= "usuário"; // database user
$dpassword 		= "senha"; // database pass
$ddatabase 		= "bando de dados"; // database name
$pro_click		= "30"; 	// default 30 seconds, Premium member visit timer
$free_click		= "45";	 // default 45 seconds, Free member visit timer
$script_path	= "seu site"; // your script have isntalled, do not include "/" slash at the end
