...
import { Bell, BookOpenCheck, CalendarClock, ChartNoAxesCombined, CircleDollarSign, ClipboardList, FileText, ImagePlus, LayoutTemplate, LifeBuoy, Library, Megaphone, Rocket, UsersRound } from "lucide-react";
