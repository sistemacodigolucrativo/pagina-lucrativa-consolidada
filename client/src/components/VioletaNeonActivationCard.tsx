...
const benefits = ["Estrutura personalizada", "Escritório Virtual", "Campanhas e pedidos"];
...
export default function VioletaNeonActivationCard({
  ...
  return <form className="violeta-neon-activation-card application-form" onSubmit={onSubmit}>
    ...
    <div className="violeta-neon-price">R$ 50,00 <small>valor da solicitação de ativação</small></div>
    <h3>Solicite sua ativação</h3>
    <p>Preencha seus dados para seguir a jornada: cadastro, pagamento, envio do comprovante, análise e acesso liberado. Sem mensalidade.</p>
    ...
    <small className="violeta-neon-privacy">Seus dados serão usados para registrar e acompanhar esta solicitação. O pagamento e o envio do comprovante acontecem na etapa seguinte do fluxo.</small>
  </form>;
}
