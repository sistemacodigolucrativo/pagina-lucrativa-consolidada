...
type AccountForm = { name: string; newPassword: string; confirmPassword: string };
...
export default function MemberAccount() {
  ...
  const [form, setForm] = useState<AccountForm>({ name: "", newPassword: "", confirmPassword: "" });
  ...
  function submit(event: FormEvent<HTMLFormElement>) {
    ...
    save.mutate({ name: form.name.trim(), newPassword: form.newPassword || null, confirmPassword: form.confirmPassword || null });
  }
