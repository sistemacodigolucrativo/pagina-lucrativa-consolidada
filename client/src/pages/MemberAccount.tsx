...
export default function MemberAccount() {
  ...
  function submit(event: FormEvent<HTMLFormElement>) {
    ...
    save.mutate({ name: form.name.trim(), email: form.email.trim(), newPassword: form.newPassword || null, confirmPassword: form.confirmPassword || null });
  }
