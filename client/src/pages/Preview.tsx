...
export default function Preview() {
  return <DashboardLayout menuItems={adminMenu} title="Administração" subtitle="Sistema"><main className="preview-portfolio-page offer-preview-page"><div className="preview-portfolio-shell">
