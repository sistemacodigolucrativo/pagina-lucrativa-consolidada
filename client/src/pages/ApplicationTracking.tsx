...
export default function ApplicationTracking() {
  ...
  function submit(event: FormEvent<HTMLFormElement>) { event.preventDefault(); setQuery({ trackingCode: trackingCode.trim().toUpperCase(), email: normalizeEmail(email) }); setLocation(`/pedido/acompanhar?codigo=${encodeURIComponent(trackingCode.trim().toUpperCase())}`); }
