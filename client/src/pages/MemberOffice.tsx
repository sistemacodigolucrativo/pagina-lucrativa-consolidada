...
const moduleDetails: Record<string, { eyebrow: string; title: string; detail: string; notes: string[] }> = {
  ...
  "/membros/blog": { eyebrow: "Material de divulgação", title: "Material de divulgação", detail: "Acesse materiais prontos para apoiar a divulgação da Página Lucrativa.", notes: ["Use banners, textos, descrições e conteúdos promocionais liberados pela administração.", "A Biblioteca de Recursos continua separada para ferramentas e arquivos externos."] },
